                    ...
                    <div class="row">
                        <div class="col-12 mb-4">
                            <div class="cases-title text-center">
                                ...
                                <p class="text-967d56 font-weight-light mb-0" style="font-size: 13px;">
                            ...
                            <div class="cases-content text-e9 font-weight-light">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <h5 class="text-967d56">量身訂製，專屬您的紅酒收藏</h5>
                                        <p class="text-e9 mb-4">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <h5 class="text-967d56">提升居家空間的格調</h5>
                                        <p class="text-e9 mb-4">
                                        ...
                                        <h5 class="text-967d56">紅酒櫃設計的無限可能</h5>
                                        <p class="text-e9 mb-4">
