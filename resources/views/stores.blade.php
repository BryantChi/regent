...
@section('content')
    ...
    <div class="container-xxl py-5 stores-bg">
            ...
            <div class="row mx-lg-5">
                <div class="col-lg-6 mb-4">
                    <div class="stores-card">
                        <div class="stores-card-map mb-4" data-aos="zoom-in" data-aos-delay="200">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="stores-card">
                        ...
                        <div class="stores-card-content text-center" data-aos="fade-up" data-aos-delay="200">
                            <h5 class="text-caa883 mb-3">林森店</h5>
                            <div class="d-flex flex-lg-row flex-column justify-content-center">
                                <p class="text-e9 font-weight-light mb-1">
                                    <img src="{{asset('assets/images/05/icon_phone.png')}}" class="img-fluid mr-1" alt="">
                                    {{-- <span class="text-997d53 mr-1"><i class="fas fa-phone-alt"></i></span> --}}
