            ...
            <div class="row justity-content-center" id="about">
                ...
                <div class="col-lg-6 pr-lg-5 pr-auto d-flex flex-column justify-content-between">
                    <div class="about-content mb-lg-4 mb-3">
                        <h5 class="text-967d56 mb-4">麗晶|品櫥 &emsp; Regent living studio</h5>
                    ...
                    <div class="about-slogan mt-lg-3 mt-1">
                        <h4 class="text-e9 font-weight-light">Create a high-quality kitchen for you.</h4>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row" id="about2">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="about-content mb-lg-4 mb-3">
                        <h5 class="text-967d56 mb-3">核心價值</h5>
                        ...
                        <h5 class="text-967d56 mb-3">特色與優勢</h5>
